...
pub mod root {
    ...
    pub mod Demo {
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN4Demo6PersonD1Ev"]
        ...
        extern "C" {
            #[link_name = "\u{1}_ZN4Demo17print_person_infoEPNS_6PersonE"]
            pub fn print_person_info(ptr: *mut root::Demo::Person);
        }
        extern "C" {
            #[link_name = "\u{1}_ZN4Demo15get_person_infoEPNS_6PersonE"]
            pub fn get_person_info(p: *mut root::Demo::Person) -> *const ::std::os::raw::c_char;
        }
        extern "C" {
            #[link_name = "\u{1}_ZN4Demo22release_person_pointerEPNS_6PersonE"]
